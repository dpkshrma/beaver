...
const TodoTimer = ({ todo, timeTillDeadline, deactivateTodo }) => {
...
const TodoItem = ({ todo, setTodoStatus, deleteTodo, onTitleClick, updateTimeTillDeadline, timeTillDeadline }) => {
      ...
      <div className="grd-todo-item-content">
        ...
        <div className="grd-todo-item-info">
          <div className="text-subtle">
            ...
            { todo.status === 'active' ? <TodoTimer todo={todo} deactivateTodo={deactivateTodo} timeTillDeadline={timeTillDeadline} /> : null }
